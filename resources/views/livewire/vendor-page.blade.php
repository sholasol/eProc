        ...
        <div class="row no-gutters">
            <div class="col-sm-6 align-self-center">
                <div class="sign-in-from">
                    ...
                    <h3 align="center">Vendor's Registration Portal</h3>
                    ...
                    {{-- <form class="mt-2" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control mb-0" id="email" class="block mt-1 w-full" name="email" :value="old('email')" autofocus>
                        </div>
                        <div class="form-group">
                   ...
                   <br> <a href="{{ route('vendor-registration')}}" class="btn btn-success btn-block">CONTINUE</a>
                </div>
            </div>
            <div class="col-sm-6 text-center">
                <div class="sign-in-detail text-white">
                    {{-- <a class="sign-in-logo mb-5" href="#"><img src="{{ asset('asset/logo.jpg') }}" class="img-fluid" alt="logo"></a> --}}
