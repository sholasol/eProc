<div class="iq-sidebar-small" style="background-color: rgb(35, 150, 102);">
    <div class="sidebar-top">
        ...
        <div class="sidebar-menu-icon">
            <a href="{{ route('h-r.dashboard') }}" class="iq-waves-effect" data-toggle="tooltip" data-placement="right"
                title="" data-original-title="Home"><i class="ri-home-2-fill"></i></a>
            ...
            <a href="{{ route('system.requestlist')}}" class="iq-waves-effect" data-toggle="tooltip" data-placement="right"
                title="" data-original-title="Requests"><i class="ri-file-upload-fill"></i></a>
            {{-- <a href="javascript:void(0);" class="iq-waves-effect" data-toggle="tooltip" data-placement="right" title=""
    ...
    <div class="sidebar-bottom">
        <div class="sidebar-menu-icon">
            <a href="{{ route('logout') }}"
                ...
                class="iq-waves-effect" data-toggle="tooltip" data-placement="right" title=""
    ...
    <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{ request()->is('h-r/dashboard') ? 'active' :' ' }}">
                    <a href="{{route('h-r.dashboard')}}" class="iq-waves-effect"><i
                            class="ri-computer-line"></i><span>Dashboard </span></a>
                </li>

                <li
                    class="{{ request()->is('system/create-user') || request()->is('system/system-users') ? 'active' :' ' }}">
                    <a href="#user" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-user-line"></i><span>Employees</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="user" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('system.create-user') }}"><i class="ri-user-add-line"></i>Create Staff</a>
                        </li>
                        <li><a href="{{ route('system.system-users') }}"><i class="ri-file-list-line"></i>Manage
                                Staff</a></li>
                    </ul>
                </li>
                <li class="{{ request()->is('system/system-department') || request()->is('system/create-department') ? 'active' :' ' }}">
                    <a href="#dept" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="fa fa-home"></i><span>Department</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="dept" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('system.create-department') }}"><i class="ri-user-add-line"></i>Create
                                Department</a></li>
                        <li><a href="{{ route('system.system-department') }}"><i class="ri-file-list-line"></i>Manage
                                Department</a></li>
                        <li><a href="{{route('system.approval-list')}}"><i class="ri-file-list-line"></i>Approval
                                Limit</a></li>
                    </ul>
                </li>
                <li class="{{ request()->is('h-r/onboard-vehicle') || request()->is('h-r/onboard-vehicle') || request()->is('h-r/type/poolcars') || request()->is('h-r/type/statuscars') ? 'active' :' ' }}">
                    <a href="#vehicles" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-roadster-fill"></i><span>Vehicles</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="vehicles" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('h-r.onboard') }}"><i class="ri-add-box-fill"></i>Onboard New Car</a>
                        </li>
                        <li>
                            <a href="#sub-menu" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                    class="ri-play-circle-line"></i><span>Vehicle Types</span><i
                                    class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                            <ul id="sub-menu" class="iq-submenu iq-submenu-data collapse">
                                <li><a href="{{ route('h-r.poolcars') }}"><i class="ri-record-circle-line"></i>Pool Car</a></li>
                                <li><a href="{{ route('h-r.statuscars') }}"><i class="ri-record-circle-line"></i>Status Car</a></li>
                            </ul>
                        </li>
                        <li><a href="{{ route('h-r.managevehicles') }}"><i class="ri-file-list-line"></i>Manage
                                Vehicles</a></li>
                        <li data-toggle="tooltip" data-placement="right" data-original-title="See Vehicle Availability For Today">
                            <a href="{{ route('h-r.vehicleavailability') }}"><i class="ri-file-list-line"></i>Vehicle Availablity</a>
                        </li>
                    </ul>
                </li>
                <li class="{{ request()->is('h-r/createtravelexpense') || request()->is('h-r/travelexpenselist') ? 'active' :' ' }}">
                    <a href="#travel" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-file-add-line"></i><span>Travel</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="travel" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('h-r.createtravexp') }}"><i class="ri-user-add-line"></i>Create Travel Template</a>
                        </li>
                        <li><a href="{{ route('h-r.travexplist') }}"><i class="ri-file-list-line"></i>Manage
                                Templates</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="#approve" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-chat-check-line"></i><span>Approval</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="approve" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('admin.user-request') }}"><i class="ri-pages-line"></i>Purchase
                                Request</a></li>
                        <li><a href="{{ route('admin.create-request') }}"><i class="ri-pages-line"></i>Create Purchase
                                Request</a></li>
                ...
                <li>
                    ...
                    <ul id="request" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('request.request') }}"><i class="ri-pages-line"></i>Purchase Requests</a>
                        </li>
                        <li><a href="{{ route('request.request-travelexpense') }}"><i class="ri-pages-line"></i>Travel
                                Expense Requests</a>
                        </li>
                        {{-- <li><a href="{{ route('request.request-carrequest') }}"><i class="ri-pages-line"></i>Travel
                                Expense
                                Requests</a></li> --}}
                        <li><a href="{{ route('request.request-carrequest') }}"><i class="ri-pages-line"></i>Pool Car
                                Requests</a></li>
                        <li><a href="{{ route('request.createrequest') }}"><i class="ri-pages-line"></i>Create
                                Request</a></li>
                    </ul>
                </li>
                <li class="">
                    <a href="{{ route('request.received')}}" class="iq-waves-effect"><i
                            class="las la-truck"></i><span>Received
                        </span></a>
                </li>
                @if (Auth::user()->utype === "HRM")
                <li>
                    <a href="#approve" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-chat-check-line"></i><span>Department Approval</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="approve" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('system.requestlist') }}"><i class="ri-pages-line"></i>Purchase
                                Request</a></li>
                        <li><a href="{{ route('system.request-carrequest') }}"><i class="ri-pages-line"></i>Pool Car
                                Request</a></li>
                        <li><a href="{{ route('system.travelrequestlist') }}"><i class="ri-pages-line"></i>Travel
                                Expense Request</a></li>
                    </ul>
                </li>
                @endif
                ...
                @if (Auth::user()->utype === "HRM")
                <li>
                    <a href="#Payroll" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-chat-check-line"></i><span>Payroll</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="Payroll" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{route('h-r.salarytemplate')}}"><i class="ri-pages-line"></i>Salary Template</a>
                        </li>
                        <li><a href="#"><i class="ri-pages-line"></i>Employee Salaries</a></li>
                        <li><a href="{{route('generate.payroll')}}"><i class="ri-pages-line"></i>Generate Monthly
                                Schedule</a></li>
                        <li><a href="{{ route('payroll.history') }}"><i class="ri-pages-line"></i>View Payroll
                                History</a></li>
                        <li><a href="{{route('generate.commission')}}"><i class="ri-pages-line"></i>Upload
                                Commission</a></li>
                    </ul>
                </li>
                @endif
            ...
            <ul class="navbar-list">
                <li>
                    <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                        <img src="{{ asset('asset/image/users')}}/{{ Auth::user()->profile_photo_path }}"
