                                ...
                                <div class="iq-card-body">
                                    <div class="user_details">
                                        <div class="user_image">
                                            <img style="width:200px;height:200px;" class="rounded-circle img-fluid avatar-40" src="<?php if(!empty($req->profile_img) && file_exists('asset/image/users/'.$req->profile_img)){
