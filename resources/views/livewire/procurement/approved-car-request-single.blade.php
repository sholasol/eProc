            ...
            <div class="col-sm-12 col-lg-12">
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        ...
                        <h4>Assignee: {{ empty($req->dfname) && empty($req->dlname)
                                            ? "Not assigned"
                                            : $req->dfname . ' ' . $req->dlname
                                        }}
                        </h4>
                        @endif
                        ...
                        <div class="col-md-12" id="Approval">
                            <hr class="text-info">
                            <form wire:submit.prevent="assignCar" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Driver</label>
                                            <select class="form-control" wire:model="selCar">
                                                <option value="">-- choose --</option>
                                                @foreach ($drivs as $driv)
                                                    <option value="{{ $driv->id }}">{{ $driv->fname. ' ' . $driv->lname }}</option>
                                                @endforeach
                                            </select>
                                            @error('selCar')<p style="color: crimson;">{{ $message }}</p> @enderror
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div wire:loading wire:target="assignCar" class="preloading">
                                            <div>
