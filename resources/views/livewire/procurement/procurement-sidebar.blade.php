<div class="iq-sidebar-small" style="background-color: rgb(35, 150, 102);">
    <div class="sidebar-top">
        ...
        <div class="sidebar-menu-icon">
            <a href="{{ route('procurement.dashboard') }}" class="iq-waves-effect" data-toggle="tooltip"
            ...
            <a href="{{ route('system.system-profile')}}" class="iq-waves-effect" data-toggle="tooltip" data-placement="right" title=""
                data-original-title="Profile"><i class="ri-user-fill"></i></a>
        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{ request()->is('admin/dashboard') ? 'active' :' ' }}">
                    <a href="{{ route('procurement.dashboard') }}" class="iq-waves-effect"><i
                            class="ri-computer-line"></i><span>Dashboard
                        </span>
                    </a>
                </li>
                {{-- <li
                    class="{{request()->is('admin/finance-payment') || request()->is('admin/finance-approval') || request()->is('admin/finance-request') || request()->is('admin/finance') ? 'active' :' ' }}">
                    <a href="#fin" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-calculator-line"></i><span>Finance</span><i
                    ...
                    <ul id="fin" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="{{ route('admin.finance-request') }}"><i class="ri-calculator-fill"></i>All
                                Requests</a></li>
                        <li><a href="{{ route('admin.finance-approval') }}"><i class="ri-task-fill"></i>Approval</a>
                        </li>
                        <li><a href="{{ route('admin.admin-finpayment') }}"><i class="ri-currency-fill"></i>Payment</a>
                        </li>
                    </ul>
                </li>
                <li
                    class="{{request()->is('procurement/claim-process') || request()->is('procurement/claim-process') || request()->is('procurement/claim-process') || request()->is('procurement/claim-process') ? 'active' :' ' }}">
                    <a href="#claim" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-profile-line"></i><span>Claims</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="claim" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('procurement.claim-process') }}"><i class="ri-calculator-line"></i>Recent
                                Claims</a></li>
                        <li><a href="{{ route('procurement.admin-claims') }}"><i class="ri-calculator-fill"></i>All
                                Claims</a></li>
                    </ul>
                </li> --}}
                <li class="{{ request()->is('system/system-users') ? 'active' :' ' }}">
                    <a href="#user" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-user-line"></i><span>System Users</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="user" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('system.system-users') }}"><i class="ri-file-list-line"></i>Staff</a></li>
                    </ul>
                </li>
                <li class="{{ request()->is('system/system-department') ? 'active' :' ' }}">
                    ...
                    <ul id="dept" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('system.system-department') }}"><i
                                    class="ri-file-list-line"></i>Departments</a></li>
                    </ul>
                </li>

                <li
                    class="{{ request()->is('system/create-vendor') || request()->is('system/system-vendor') ? 'active' :' ' }}">
                    <a href="#ven" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-user-line"></i><span>Vendors</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="ven" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('system.create-vendor') }}"><i class="ri-user-add-line"></i>Create
                                Vendor</a></li>
                        <li><a href="{{ route('system.system-vendors') }}"><i class="ri-file-list-line"></i>Manage
                                Vendors</a></li>
                    </ul>
                </li>
                <li
                    class="{{ request()->is('system/create-email') || request()->is('system/email') ? 'active' :' ' }}">
                ...
                <li>
                    ...
                    <ul id="ecommerce" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{ route('procurement.awaiting-request') }}"><i class="ri-pages-line"></i>Awaiting Purchase Requests</a></li>
                        <li><a href="{{ route('procurement.awaiting-servicelist') }}"><i class="ri-pages-line"></i>Awaiting Service Requests</a></li>
                        <li><a href="{{ route('procurement.awaiting-carrequest') }}"><i class="ri-pages-line"></i>Awaiting Car Requests</a></li>
                        <li><a href="{{ route('procurement.awaiting-travellist') }}"><i class="ri-pages-line"></i>Awaiting Travel Requests</a></li>
                        <li><a href="{{ route('procurement.rfq') }}"><i class="ri-file-list-line"></i>RFQ</a></li>
