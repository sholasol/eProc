        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-12">
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        @if ($req->tran_approval =="" || $req->tran_approval == null)
                                    ...
                                    <form wire:submit.prevent="approveRequest" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Garage</label>
                                                    <input class="form-control" wire:model="garage">
                                                    @error('garage')<p style="color: crimson;">{{ $message }}</p> @enderror
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                        ...
                        @elseif ($req->tran_approval ==="Approved" )
                        <div class="iq-card">
                            <div class="col-md-12">
                                <h4>Garage:</h4>
                                {{ $req->garage }}
