<div class="iq-sidebar-small" style="background-color: rgb(35, 150, 102);">
    <div class="sidebar-top">
       ...
       <div class="sidebar-menu-icon">
          <a href="{{ route('vendor.dashboard') }}" class="iq-waves-effect" data-toggle="tooltip" data-placement="right" title="" data-original-title="Home"><i class="ri-home-2-fill"></i></a>
       ...
       <nav class="iq-sidebar-menu">
          <ul id="iq-sidebar-toggle" class="iq-menu">
             ...
             <li class="{{ request()->is('vendor/dashboard') ? 'active' :' ' }}">
                <a href="{{ route('vendor.dashboard') }}" class="iq-waves-effect"><i class="ri-computer-line"></i><span>Dashboard </span></a>
             </li>
             ...
             <li class="iq-menu-title"><i class="ri-subtract-line"></i><span>Quote Process</span></li>
             <li>
               <a href="#request" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-pages-line"></i><span>Generate Quote</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
               <ul id="request" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                  <li><a href=""><i class="ri-pages-line"></i>Create Quote</a></li>
                  <li><a href=""><i class="ri-file-list-line"></i>RFQ</a></li>
               </ul>
            </li>
