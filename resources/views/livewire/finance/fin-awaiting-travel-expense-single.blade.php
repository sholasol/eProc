        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-12">
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        @if ($req->proc_approval =="Approved" && ($req->fin_approval === null || $req->fin_approval ==="Revised"))
                        ...
                        @elseif ($req->fin_approval ==="Approved" )
                                    ...
                                    <div class="iq-card-body">
                                        <div class="table-responsive-sm">
                                            <table class="table table-striped">
                                                ...
                                                <tr>
                                                    <th>Duration</th>
                                                    <td>{{ $req->duration}}&nbsp;{{ $req->duration > 1 ? 'days' : 'day'
                                                        }}</td>
                                                </tr>
                                                <tr>
                                                    <th>Departure</th>
                                                ...
                                                <tr>
                                                    <th>Return Date</th>
                                                    <td>{{ \Carbon\Carbon::parse($req->return_date)->format('Y-m-d') }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Total Expense</th>
