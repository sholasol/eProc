{{-- <div id="content-page" class="content-page">
 ...
 <div id="content-page" class="content-page">
    <div class="container-fluid">
       <form wire:submit.prevent="updVendor" enctype="multipart/form-data">
        @csrf
        <div class="row">
            {{-- <div class="col-lg-3">
                  <div class="iq-card">
                            ...
                            <div class="row">
                              ...
                              <div class="row">
                                 <div class="form-group col-md-6">
                                    ...
                                    @error('approval')<p style="color: crimson;">{{ $message }}</p> @enderror
                                 </div>
                                 <div class="form-group col-md-6">
                                    <label for="pass">Remark:</label>
                                    <input type="text" class="form-control" id="pass" placeholder="Remark" wire:model="remark">
