                        ...
                        <table id="user-list-table" class="table table-striped table-bordered mt-4" role="grid"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user->phone }}</td>
                                    <td>{{ $user->email }}</td>
                                    <td><span class="badge iq-bg-primary" style="color: black !important;">{{ $user->deptname }}</span></td>
                                        ...
                                        <div class="flex align-items-center list-user-action flex-nowrap">
                                            ...
                                            <a class="bg-info" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Profile"
                                                ...
                                                @if ($user->condition == "Active")
                                                    <a class="bg-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Deactivate User"
                                                ...
                                                @else
                                                    <a class="bg-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Activate User"
                                                        href="javascript:void();"
                                                        onclick="confirm('Are you sure, you want to make this user active?') ||event.stopImmediatePropagation()"
                                                        wire:click.prevent="updateUsr({{ $user->id }})">
                                                        <i class="ri-delete-bin-line text-white"></i>
                                                    </a>
                                                @endif
