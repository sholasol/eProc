                                    ...
                                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                       <div class="btn-group" role="group">
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                             ...
                                             <a class="dropdown-item" onclick="confirm('Are you sure, you want to approve this request?') ||event.stopImmediatePropagation()" wire:click.prevent="approvalProcess({{ 1 }})">Approve</a>
