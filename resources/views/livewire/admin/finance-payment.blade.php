                    ...
                    <div class="iq-card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                                <h4 class="mb-0 float-right">Payment</h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h5 class="mt-5">Vemdor's Details</h5>
                                <div class="table-responsive-sm">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
            ...
            <div class="col-sm-4">
                <div class="iq-card">
                   <div class="iq-card-body">
                      ...
                      <a href="" class="btn btn-success d-block mt-1 next">Approvel Request</a>
                  ...
                  <div class="card-body iq-card-body p-0 iq-checkout-policy">
                      <ul class="p-0 m-0">
                         ...
                         <li class="d-flex align-items-center">
                            ...
                            </div><h6>Return policy (Easy Retyrn.)</h6>
                         </li>
                      </ul>
                   </div>
                </div> --}}
