<div class="iq-sidebar-small" style="background-color: rgb(35, 150, 102);">
    <div class="sidebar-top">
       ...
       <div class="sidebar-menu-icon">
          <a href="{{ route('user.dashboard') }}" class="iq-waves-effect" data-toggle="tooltip" data-placement="right" title="" data-original-title="Home"><i class="ri-home-2-fill"></i></a>
          ...
          <a href="" class="iq-waves-effect" data-toggle="tooltip" data-placement="right" title="" data-original-title="Social"><i class="ri-command-fill"></i></a>
       ...
       <nav class="iq-sidebar-menu">
          <ul id="iq-sidebar-toggle" class="iq-menu">
             ...
             <li class="{{ request()->is('user/dashboard') ? 'active' :' ' }}">
                <a href="{{ route('user.dashboard') }}" class="iq-waves-effect"><i class="ri-computer-line"></i><span>Dashboard </span></a>
             </li>
             {{-- <li class="">
                <a href="" class="iq-waves-effect"><i class="ri-calculator-line"></i><span>Requests </span></a>
             </li> --}}

             <li class="">
                <a href="" class="iq-waves-effect"><i class="las la-home"></i><span>Departments </span></a>
             </li>

             <li class="">
                <a href="" class="iq-waves-effect"><i class="ri-user-line"></i><span>Contacts </span></a>
             </li>
             <li class="{{ request()->is('admin/create-email') || request()->is('admin/admin-email') ? 'active' :' ' }}">
                ...
                <ul id="mailbox" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                   <li><a href="{{ route('user.user-email') }}"><i class="ri-inbox-line"></i>Inbox</a></li>
