                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">Role & Profile Image</h4>
                            </div>
                        </div>
                        <div class="iq-card-body">
                            <div class="form-group">
                                <div class="add-img-user profile-img-edit">
                                    @if ($image)
                                        <img class="profile-pic img-fluid" src="{{ $image->temporaryUrl() }}" width="120"
                                            alt="">
                                    @else
                                        <img class="profile-pic img-fluid" title="Dummy Image" src="
                                    ...
                                    <div class="p-image">
                                        <a href="javascript:void();"
                                            class="upload-button btn iq-bg-success"><small>Upload Profile
                                                Pic</small></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline"
                                                ...
                                                <input type="radio" id="customRadio6" name="customRadio1"
                                                    class="custom-control-input" @if ($gender=="Male") checked @endif />
                                                <label class="custom-control-label" for="customRadio6">Male</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline"
                                                wire:click="$set('gender', 'Female')">
                                                <input type="radio" id="customRadio7" name="customRadio1"
                                                    class="custom-control-input" @if ($gender=="Female") checked @endif />
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="qualification"
                                                placeholder="Enter qualification..." wire:model="qualification">
                                            @error('qualification')<p style="color: crimson;">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="text"
                                                placeholder="Enter state of origin..." id="city" wire:model="city" />
                                            @error('city')<p style="color: crimson;">{{ $message }}</p> @enderror
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="country">Country:</label>
                                            <input class="form-control" type="text"
                                                placeholder="Enter country of birth..." id="country"
                                                wire:model="country" />
