                ...
                <div class="iq-card-body">
                   <div class="">
                      <div class="iq-email-list">
                         <a href="{{route('user.create-email')}}" class="btn btn-primary btn-lg btn-block mb-3 font-size-16 p-3"><i class="ri-send-plane-line mr-2"></i>New Message</a>
                         <div class="iq-email-ui nav flex-column nav-pills">
                            <li class="nav-link active" role="tab" data-toggle="pill" href="#mail-inbox"><a href="{{route('user.user-email')}}"><i class="ri-mail-line"></i>Inbox<span class="badge badge-primary ml-2">4</span></a></li>
